...
task deplete_taxa {
  ...
  command {
    ...
    reports.py fastqc ${bam_basename}.cleaned.bam ${bam_basename}.cleaned_fastqc.html ${bam_basename}.cleaned_fastqc.zip
  }
...
task filter_to_taxon {
  ...
  command {
    ...
    reports.py fastqc ${bam_basename}.taxfilt.bam ${bam_basename}.taxfilt_fastqc.html ${bam_basename}.taxfilt_fastqc.zip
  }
