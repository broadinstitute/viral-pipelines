...
task table2asn {
  ...
  input {
    ...
    String       docker = "quay.io/broadinstitute/viral-ngs:3.0.21-phylo"  # this could be a simpler docker image, we don't use anything beyond table2asn itself
  }
  Int disk_size = 50
...
task genbank_special_taxa {
  ...
  input {
    ...
    String  docker = "quay.io/broadinstitute/viral-ngs:3.0.21-classify"
  }
