...
task download_fasta {
  input {
    ...
    String         docker = "quay.io/broadinstitute/viral-ngs:3.0.13-phylo"
  }
...
task sequencing_platform_from_bam {
  input {
    ...
    String  docker = "quay.io/broadinstitute/viral-ngs:3.0.13-core"
  }
...
task generate_author_sbt_file {
  ...
  input {
    ...
    String  docker = "quay.io/broadinstitute/py3-bio:0.1.7"
  }
...
task table2asn {
  ...
  input {
    ...
    String       docker = "quay.io/broadinstitute/viral-ngs:3.0.13-phylo"  # this could be a simpler docker image, we don't use anything beyond table2asn itself
  }
  Int disk_size = 50
...
task package_special_genbank_ftp_submission {
  ...
  input {
    ...
    String  docker = "quay.io/broadinstitute/viral-ngs:3.0.13-baseimage"
  }
  command <<<
    set -e
