...
task download_fasta {
  input {
    ...
    String         docker = "quay.io/broadinstitute/viral-phylo:2.5.21.4"
  }
...
task table2asn {
  ...
  input {
    ...
    String       docker = "quay.io/broadinstitute/viral-phylo:2.5.21.4"  # this could be a simpler docker image, we don't use anything beyond table2asn itself
  }
  Int disk_size = 50
